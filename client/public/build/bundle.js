...
var app = (function () {
    ...
    var slots=[{u1:{vol:0,pan:64},u2:{vol:127,pan:64},l:{vol:0,pan:64}},{u1:{vol:86,pan:64},u2:{vol:0,pan:64},l:{vol:0,pan:64}},{u1:{vol:0,pan:64},u2:{vol:0,pan:64},l:{vol:0,pan:64}},{u1:{vol:127,pan:64},u2:{vol:127,pan:64},l:{vol:127,pan:64}}];var cfg$1 = {slots:slots};
    ...
    function openFile(e) {
        ...
        // const filter = dialog.DialogFilter({
        //     name: 'main',
        //     extensions: ['rbk']
        // });
        dialog.open({
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			p = element("p");
    			p.textContent = "Drop an RBK file here to import...";
    			t5 = space();
    			div2 = element("div");
    			input = element("input");
    			t6 = space();
    			...
    			button0.textContent = "Export RBK File";
    			t9 = space();
    			button1 = element("button");
    			button1.textContent = "Open...";
    			add_location(h2, file$1, 28, 8, 828);
    			add_location(h4, file$1, 29, 8, 855);
    			add_location(div0, file$1, 27, 4, 814);
    			add_location(p, file$1, 32, 8, 989);
    			attr_dev(div1, "class", "dragdrop svelte-1bby57r");
    			attr_dev(div1, "ondrop", drop);
    			attr_dev(div1, "ondragover", allowDrop);
    			add_location(div1, file$1, 31, 4, 917);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "input-filename");
    			attr_dev(input, "name", "filename");
    			add_location(input, file$1, 35, 8, 1103);
    			add_location(br, file$1, 36, 8, 1194);
    			add_location(button0, file$1, 40, 8, 1323);
    			add_location(button1, file$1, 43, 8, 1410);
    			set_style(div2, "padding-top", "22px");
    			set_style(div2, "text-align", "left");
    			add_location(div2, file$1, 34, 4, 1046);
    			attr_dev(div3, "id", "libctrl");
    			attr_dev(div3, "class", "svelte-1bby57r");
    			add_location(div3, file$1, 26, 0, 791);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", handleExport, false, false, false),
    					listen_dev(button1, "click", openFile, false, false, false)
    				];
